---
title: "BÁO CÁO TỔNG HỢP ĐỀ DƯỠNG TÂM THANG"
subtitle: "Viết trước dựa trên dữ liệu mô phỏng"
...
bibliography: duong_tam_thang.bib
csl: apa.csl
editor: visual
---
...
library(pacman)
pacman::p_load(
  officedown, haven, tidyverse, labelled, ggplot2,
  gt, flextable, kableExtra, officer, lubridate, glue
)
...
Theo nghiên cứu của chúng tôi Tuổi trung bình của toàn bộ mẫu là  `r age_all_mean` ± `r age_all_sd` tuổi. Trong khi đó tuổi trung bình của nhóm nghiên cứu là **`r age_summary$mean_age[age_summary$group == "Nhóm nghiên cứu"]` ± `r age_summary$sd_age[age_summary$group == "Nhóm nghiên cứu"]`** tuổi, nhóm đối chứng là **`r age_summary$mean_age[age_summary$group == "Nhóm đối chứng"]` ± `r age_summary$sd_age[age_summary$group == "Nhóm đối chứng"]`** tuổi. So với tác giả Kết quả này tương đồng với nghiên cứu của Yeung và cs  là 48,00 [@chung2018acupuncture], Jing Gou và cộng sự  là 48,93, Lê Thị Tường Vân (2015) là 50,07[@van2015matngu], Đoàn Văn Minh (2009) là 49,30, [@minh2009matngu]. Kết quả tuổi trung bình dân số nghiên cứu của chúng tôi thấp hơn nghiên cứu của KF Chung là 53,40 và cao hơn nghiên cứu của Y Jiao là 41,96 . Khác biệt này có thể do khác biệt về thiết kế nghiên cứu, cỡ mẫu và tỷ lệ các nhóm tuổi trong dân số nghiên cứu @minh2009matngu.
