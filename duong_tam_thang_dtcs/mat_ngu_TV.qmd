---
title: "PHÂN TÍCH KẾT QUẢ NGHIÊN CỨU ĐỀ TÀI MẤT NGỦ"
subtitle: "Đánh giá biến số chính: PSQI"
author: "Đội ngũ nghiên cứu: YHCT"
...
##### Sự khác biệt không có y nghĩa thống kê với p = `r giatri_p_dinhdang`

#### Biểu đồ đặc điểm theo tuổi
...
##### Biểu đồ cho thấy Tuổi trung bình của nhóm nghiên cứu là `r age_summary$mean_age[age_summary$group == "Nhóm nghiên cứu"]` ± `r age_summary$sd_age[age_summary$group == "Nhóm nghiên cứu"]` tuổi, trong khi nhóm đối chứng là `r age_summary$mean_age[age_summary$group == "Nhóm đối chứng"]` ± `r age_summary$sd_age[age_summary$group == "Nhóm đối chứng"]` tuổi.
...
Tuổi trung bình của toàn bộ mẫu là **`r age_all_mean` ± `r age_all_sd`** tuổi. Trong khi đó tuổi trung bình của nhóm nghiên cứu là `r age_summary$mean_age[age_summary$group == "Nhóm nghiên cứu"]` ± `r age_summary$sd_age[age_summary$group == "Nhóm nghiên cứu"]` tuổi, nhóm đối chứng là `r age_summary$mean_age[age_summary$group == "Nhóm đối chứng"]` ± `r age_summary$sd_age[age_summary$group == "Nhóm đối chứng"]` tuổi. So với tác giả
Kết quả này tương đồng với nghiên cứu của Yeung và cs (2009) là 48,00, Jing Gou và cộng sự (2013) là 48,93, Lê Thị Tường Vân (2015) là 50,07, Đoàn Văn Minh (2009) là 49,30 [37], [43]  [@minh2009matngu]. Kết quả tuổi trung bình dân số nghiên cứu của chúng tôi thấp hơn nghiên cứu của KF Chung là 53,40 và cao hơn nghiên cứu của Y Jiao là 41,96  [8], [44]. Khác biệt này có thể do khác biệt về thiết kế nghiên cứu, cỡ mẫu và tỷ lệ các nhóm tuổi trong dân số nghiên cứu.
